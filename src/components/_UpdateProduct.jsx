...
export default function _UpdateProduct() {
  ...
  const getProduct = async ()=>{
    const res = await axios.get(`https://ennmartserver.up.railway.app/api/v1/products/${id}`)
    const data = res.data;
    setProduct(data)
...
try {
  ...
  const first = await axios.post("https://api.cloudinary.com/v1_1/dy9crvf1i/image/upload", data)
        ...
        const third = await    axios.post("https://ennmartserver.up.railway.app/api/v1", allData)
