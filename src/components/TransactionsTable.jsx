    ...
    return (
        <div className="w-11/12 mx-auto rounded-md overflow-x-scroll bg-gray-50 p-1">
            {sortedData && sortedData.items.length > 0 && (
                <div className="flex flex-col justify-start  px-10 items-center">
                ...
                <tbody>
                    {sortedData && sortedData.items.length > 0 ? sortedData.items.slice(0, selectedRows).map((item, index) => (
                        ...
                        <tr key={index} className={` py-3 ${index % 2 === 0 && "bg-gray-200"}`}>
                            ...
                            <td className="px-4 py-2 ">{
                               <img src={`${item.transfers[0].logo_url}`} className={`w-10 h-10`} alt="" />
                            }</td>
                            ...
                            <td className="px-4 py-2 text-center ">
                                {sortedData.address === item.transfers[0].to_address && (
                                    <span>IN</span>
                                )}
                                {sortedData.address === item.transfers[0].from_address && (
                                    <span>OUT</span>
                                )}
                            </td>
                            <td className="px-4 py-2 ">{
